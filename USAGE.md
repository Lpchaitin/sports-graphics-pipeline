...
```bash
python convert_predictions.py modeling/mlb_xgb_ml/predictions/predictions_2026-04-19.csv
```
...
```bash
python process_picks.py converted_predictions_2026-04-19.csv \
...
Then update `convert_predictions.py` to map that column to `ou_pick`.
